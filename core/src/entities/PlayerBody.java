...
public class PlayerBody {
    ...
    public static boolean bJump, bDone, bHit, bDead = false, bLeft = false;
    //Music jumpsound = Gdx.audio.newMusic(Gdx.files.internal("Super Mario Bros. - Jump Sound Effect.mp3"));
